...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        func setUpLeftSideUI() {
         ...
         priceLabelLeft.text = house1!.price!   //to be sure that at this point we have a non nil value for house1
         roomLabelLeft.text = house1!.bedrooms! //and in case we have it, take the proper considerations (default value, etc...)
                                                ...
                                                //we would have a nil value for house1 and (in this particular case) only the image
                                                //would be shown on screen (because we do not have any value for any label)
        }
...
struct House: Equatable { //Conforms to Equatable to be able to perform testing using ==
        var address: String?
        var price: String?
        var bedrooms: String?
    }
